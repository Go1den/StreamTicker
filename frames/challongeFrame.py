from tkinter import Frame, GROOVE, StringVar, Label, Entry, W, Checkbutton, BooleanVar, NORMAL, IntVar
...
class ChallongeFrame:
    def __init__(self, challongeWindow):
        ...
        self.recentRoundsFrame.grid(row=5, column=0, columnspan=3, padx=4, pady=(0,4), sticky=W)
