...
class MessageMakerButtonFrame:
    def __init__(self, messageMakerPartFrame):
        ...
        self.editButton = Button(self.frame, text="Edit", width=BUTTON_WIDTH, bd=BUTTON_BORDER, relief=GROOVE, command=lambda: self.messageMakerPartFrame.listFrame.getMessageMakerWindow(True))
        ...
        self.addButton = Button(self.frame, text="New", width=BUTTON_WIDTH, bd=BUTTON_BORDER, relief=GROOVE, command=lambda: self.messageMakerPartFrame.listFrame.getMessageMakerWindow(False))
