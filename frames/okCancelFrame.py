    ...
    def updateCurrentSettings(self):
        if self.validateBeforeSaving():
            result = {
                ...
                'window': {
                    'MESSAGE_X_POS': self.window.fields.VAR_ENTRY_MESSAGE_X_POS.get(),
                    'IMAGE_X_POS': self.window.fields.VAR_ENTRY_IMAGE_X_POS.get(),
                    'WINDOW_WIDTH': self.window.fields.VAR_ENTRY_WINDOW_WIDTH.get(),
                    'WINDOW_HEIGHT': self.window.fields.VAR_ENTRY_WINDOW_HEIGHT.get(),
                    ...
                    'BACKGROUND_X_POS': self.window.fields.VAR_ENTRY_BACKGROUND_X_POS.get(),
                    'BACKGROUND_Y_POS': self.window.fields.VAR_ENTRY_BACKGROUND_Y_POS.get(),
