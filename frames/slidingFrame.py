...
class SlidingFrame:
    def __init__(self, master, fields):
        ...
        self.LABEL_WINDOW_SETTINGS.grid(row=0, column=0, sticky=W)
        ...
        self.SCALE_WINDOW_WIDTH.grid(row=1, column=0)
        ...
        self.SCALE_IMAGE_X_POS.grid(row=1, column=1)
        ...
        self.SCALE_MESSAGE_X_POS.grid(row=2, column=0)
        ...
        self.SCALE_BG_X_POS.grid(row=2, column=1)
        ...
        self.SCALE_WINDOW_HEIGHT.grid(row=3, column=0)
        ...
        self.SCALE_BG_Y_POS.grid(row=3, column=1)
