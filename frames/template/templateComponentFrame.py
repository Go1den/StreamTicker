...
class TemplateComponentFrame:
    def __init__(self, parent):
        ...
        labelTemplateSettings = Label(self.frame, text="Component Settings")
        labelTemplateSettings.grid(row=0, column=0, sticky=W, columnspan=3, padx=1, pady=1)
