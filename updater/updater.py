...
from os import getcwd, walk, remove, chdir, makedirs
...
print("Update in progress. Please wait. Your program will restart automatically.")
...
print("The updater has finished. Restarting StreamTicker...")
sleep(3)
