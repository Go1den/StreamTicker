...
class MessageFrame:
    def __init__(self, master, fields):
        ...
        Label(self.frame, text="Message Settings").grid(row=0, column=0, columnspan=3, sticky=W, pady=1)
        self.LABEL_MESSAGE_DURATION = Label(self.frame, text="Message Duration:")
        self.LABEL_MESSAGE_DURATION.grid(row=1, column=0, sticky=E, pady=1)
        ...
        messageDurationFrame.grid(row=1, column=1, sticky=W, pady=1)

        self.LABEL_MESSAGE_INTERMISSION = Label(self.frame, text="Time Between Each Message:")
        self.LABEL_MESSAGE_INTERMISSION.grid(row=2, column=0, sticky=E, pady=1)
        ...
        messageIntermissionFrame.grid(row=2, column=1, sticky=W, pady=1)
        ...
        self.LABEL_MESSAGE_FONT_FACE.grid(row=3, column=0, sticky=E, pady=1)
        ...
        self.FONT_COMBO_BOX.grid(row=3, column=1, sticky=W, pady=1)
        ...
        self.BUTTON_MESSAGE_COLOR.grid(row=4, column=0, sticky=E, padx=4, pady=1)
        ...
        messageColorFrame.grid(row=4, column=1, sticky=W, pady=1)
        ...
        self.LABEL_NORMAL_FONT_SIZE.grid(row=5, column=0, sticky=E, pady=1)
        self.ENTRY_NORMAL_FONT_SIZE = Entry(self.frame, textvariable=fields.VAR_ENTRY_NORMAL_FONT_SIZE, width=4)
        self.ENTRY_NORMAL_FONT_SIZE.grid(row=5, column=1, sticky=W, pady=1)
        ...
        self.LABEL_MAX_LENGTH_FOR_NORMAL_FONT_SIZE.grid(row=6, column=0, sticky=E, pady=1)
        ...
        maxLengthFrame.grid(row=6, column=1, sticky=W, pady=1)
        ...
        self.LABEL_SMALLER_FONT_SIZE.grid(row=7, column=0, sticky=E, pady=1)
        self.ENTRY_SMALLER_FONT_SIZE = Entry(self.frame, textvariable=fields.VAR_ENTRY_SMALLER_FONT_SIZE, width=4)
        self.ENTRY_SMALLER_FONT_SIZE.grid(row=7, column=1, sticky=W, pady=1)

        self.LABEL_MOVE_ALL_ON_LINE_DELAY = Label(self.frame, text="Message Scroll Speed:")
        self.LABEL_MOVE_ALL_ON_LINE_DELAY.grid(row=8, column=0, sticky=E, pady=1)
        ...
        self.MESSAGE_SPEED_COMBO_BOX.grid(row=8, column=1, sticky=W, pady=1)
