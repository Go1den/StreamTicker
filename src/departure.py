...
from src.settings import MOVE_ALL_ON_LINE_DELAY, WINDOW_BG_COLOR, WINDOW_WIDTH, WINDOW_HEIGHT, ENABLE_DEPARTING_BY_SLIDING_RIGHT, ENABLE_DEPARTING_BY_SLIDING_DOWN, \
