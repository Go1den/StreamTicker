...
LABEL_SCALE_WINDOW_WIDTH = Label(sliderFrame)
LABEL_SCALE_WINDOW_WIDTH.grid(row=1, column=0, sticky=W)
SCALE_WINDOW_WIDTH = Scale(sliderFrame, from_=400, to=1920, tickinterval=1520, orient=HORIZONTAL, resolution=4, length=500, command=lambda x: updateXScales(), label="Window Width in Pixels:")
SCALE_WINDOW_WIDTH.set(400)
SCALE_WINDOW_WIDTH.grid(row=1, column=1, sticky=W)

LABEL_SCALE_IMAGE_X_POS = Label(sliderFrame)
LABEL_SCALE_IMAGE_X_POS.grid(row=1, column=2, sticky=W)
SCALE_IMAGE_X_POS = Scale(sliderFrame, from_=0, to=400, tickinterval=400, orient=HORIZONTAL, resolution=1, length=500, label="Image X Coordinate (location of image center)")
SCALE_IMAGE_X_POS.set(400)
SCALE_IMAGE_X_POS.grid(row=1, column=3, sticky=W)

LABEL_SCALE_MESSAGE_X_POS = Label(sliderFrame)
LABEL_SCALE_MESSAGE_X_POS.grid(row=2, column=0, sticky=W)
SCALE_MESSAGE_X_POS = Scale(sliderFrame, from_=0, to=400, tickinterval=40, orient=HORIZONTAL, resolution=1, length=500, label="Message X Coordinate (location of message start)")
SCALE_MESSAGE_X_POS.set(400)
SCALE_MESSAGE_X_POS.grid(row=2, column=1, sticky=W)

LABEL_SCALE_BG_X_POS = Label(sliderFrame)
LABEL_SCALE_BG_X_POS.grid(row=2, column=2, sticky=W)
SCALE_BG_X_POS = Scale(sliderFrame, from_=0, to=400, tickinterval=400, orient=HORIZONTAL, resolution=1, length=500, label="Background X Coordinate (location of BG center)")
SCALE_BG_X_POS.set(400)
SCALE_BG_X_POS.grid(row=2, column=3, sticky=W)

LABEL_SCALE_WINDOW_HEIGHT = Label(sliderFrame)
LABEL_SCALE_WINDOW_HEIGHT.grid(row=3, column=0, sticky=W)
SCALE_WINDOW_HEIGHT = Scale(sliderFrame, from_=40, to=1080, tickinterval=1040, orient=HORIZONTAL, resolution=4, length=500, command=lambda x: updateYScales(), label="Window Height in Pixels:")
SCALE_WINDOW_HEIGHT.set(40)
SCALE_WINDOW_HEIGHT.grid(row=3, column=1, sticky=W)

LABEL_SCALE_BG_Y_POS = Label(sliderFrame)
LABEL_SCALE_BG_Y_POS.grid(row=3, column=2, sticky=W)
SCALE_BG_Y_POS = Scale(sliderFrame, from_=0, to=40, tickinterval=40, orient=HORIZONTAL, resolution=1, length=500, label="Background Y Coordinate (location of BG center)")
SCALE_BG_Y_POS.set(40)
