...
def updateXScales():
    SCALE_IMAGE_X_POS.configure(to=SCALE_WINDOW_WIDTH.get(), tickinterval=SCALE_WINDOW_WIDTH.get())
    SCALE_BG_X_POS.configure(to=SCALE_WINDOW_WIDTH.get(), tickinterval=SCALE_WINDOW_WIDTH.get())
    SCALE_MESSAGE_X_POS.configure(to=SCALE_WINDOW_WIDTH.get(), tickinterval=SCALE_WINDOW_WIDTH.get())

def updateYScales():
    SCALE_BG_Y_POS.configure(to=SCALE_WINDOW_HEIGHT.get(), tickinterval=SCALE_WINDOW_HEIGHT.get())
...
def loadDefault(fields, messageLabel, windowLabel):
...
dFrame = Frame(master, bd=2, relief=GROOVE)
wFrame = Frame(master, bd=2, relief=GROOVE)
mFrame = Frame(master, bd=2, relief=GROOVE)
...
filemenu.add_command(label="New Settings", command=lambda: loadDefault(fields, LABEL_MESSAGE_COLOR, LABEL_WINDOW_BG_COLOR))
...
Label(wFrame, text="Background Settings").grid(row=0, column=0, sticky=W)
BUTTON_WINDOW_BG_COLOR = Button(wFrame, text='Background Color:', command=lambda: updateWindowColor(LABEL_WINDOW_BG_COLOR, fields))
...
BUTTON_WINDOW_BG_COLOR.grid(row=1, column=0, sticky=E, padx=4)
LABEL_WINDOW_BG_COLOR.grid(row=1, column=1, sticky=W)
LABEL_WINDOW_BG_IMAGE = Label(wFrame, textvariable=fields.VAR_DISPLAY_WINDOW_BG_IMAGE)
BUTTON_WINDOW_BG_IMAGE = Button(wFrame, text='Background Image:', command=lambda: selectImageFile(fields))
...
BUTTON_WINDOW_BG_IMAGE.grid(row=2, column=0, sticky=E, padx=4, pady=4)
LABEL_WINDOW_BG_IMAGE.grid(row=2, column=1, sticky=W)

Label(mFrame, text="Message Settings").grid(row=0, column=0, columnspan=3, sticky=W)
...
LABEL_MESSAGE_DURATION.grid(row=1, column=0, sticky=E)
ENTRY_MESSAGE_DURATION = Entry(mFrame, textvariable=fields.VAR_ENTRY_MESSAGE_DURATION, width=4)
ENTRY_MESSAGE_DURATION.grid(row=1, column=1, sticky=W)
...
LABEL_MESSAGE_FONT_FACE.grid(row=2, column=0, sticky=E)
...
FONT_COMBO_BOX.grid(row=2, column=1, sticky=W)
...
BUTTON_MESSAGE_COLOR.grid(row=3, column=0, sticky=E, padx=4)
LABEL_MESSAGE_COLOR.grid(row=3, column=1, sticky=W)
Label(mFrame, text="Normal Message Font Settings").grid(row=4, column=0, sticky=W)
...
LABEL_NORMAL_FONT_SIZE.grid(row=5, column=0, sticky=E)
ENTRY_NORMAL_FONT_SIZE = Entry(mFrame, textvariable=fields.VAR_ENTRY_NORMAL_FONT_SIZE, width=4)
ENTRY_NORMAL_FONT_SIZE.grid(row=5, column=1, sticky=W)
...
LABEL_NORMAL_FONT_SIZE_GAP.grid(row=6, column=0, sticky=E)
ENTRY_NORMAL_FONT_SIZE_GAP = Entry(mFrame, textvariable=fields.VAR_ENTRY_NORMAL_FONT_SIZE_GAP, width=4)
ENTRY_NORMAL_FONT_SIZE_GAP.grid(row=6, column=1, sticky=W)
...
LABEL_NORMAL_FONT_SIZE_GAP_FOR_SPACES.grid(row=7, column=0, sticky=E)
ENTRY_NORMAL_FONT_SIZE_GAP_FOR_SPACES = Entry(mFrame, textvariable=fields.VAR_ENTRY_NORMAL_FONT_SIZE_GAP_FOR_SPACES, width=4)
ENTRY_NORMAL_FONT_SIZE_GAP_FOR_SPACES.grid(row=7, column=1, sticky=W)
...
LABEL_MAX_LENGTH_FOR_NORMAL_FONT_SIZE.grid(row=8, column=0, sticky=E)
ENTRY_MAX_LENGTH_FOR_NORMAL_FONT_SIZE = Entry(mFrame, textvariable=fields.VAR_ENTRY_MAX_LENGTH_FOR_NORMAL_FONT_SIZE, width=4)
ENTRY_MAX_LENGTH_FOR_NORMAL_FONT_SIZE.grid(row=8, column=1, sticky=W)
...
LABEL_MESSAGE_INTERMISSION.grid(row=1, column=2, sticky=E)
ENTRY_MESSAGE_INTERMISSION = Entry(mFrame, textvariable=fields.VAR_ENTRY_MESSAGE_INTERMISSION, width=4)
ENTRY_MESSAGE_INTERMISSION.grid(row=1, column=3, sticky=W)
...
LABEL_MOVE_ALL_ON_LINE_DELAY.grid(row=2, column=2, sticky=E)
ENTRY_MOVE_ALL_ON_LINE_DELAY = Entry(mFrame, textvariable=fields.VAR_ENTRY_MOVE_ALL_ON_LINE_DELAY, width=4)
ENTRY_MOVE_ALL_ON_LINE_DELAY.grid(row=2, column=3, sticky=W)
Label(mFrame, text="Long Message Font Settings").grid(row=4, column=2, sticky=W)
...
LABEL_SMALLER_FONT_SIZE.grid(row=5, column=2, sticky=E)
ENTRY_SMALLER_FONT_SIZE = Entry(mFrame, textvariable=fields.VAR_ENTRY_SMALLER_FONT_SIZE, width=4)
ENTRY_SMALLER_FONT_SIZE.grid(row=5, column=3, sticky=W)
...
LABEL_SMALLER_FONT_SIZE_GAP.grid(row=6, column=2, sticky=E)
ENTRY_SMALLER_FONT_SIZE_GAP = Entry(mFrame, textvariable=fields.VAR_ENTRY_SMALLER_FONT_SIZE_GAP, width=4)
ENTRY_SMALLER_FONT_SIZE_GAP.grid(row=6, column=3, sticky=W)
...
LABEL_SMALLER_FONT_SIZE_GAP_FOR_SPACES.grid(row=7, column=2, sticky=E)
ENTRY_SMALLER_FONT_SIZE_GAP_FOR_SPACES = Entry(mFrame, textvariable=fields.VAR_ENTRY_SMALLER_FONT_SIZE_GAP_FOR_SPACES, width=4)
ENTRY_SMALLER_FONT_SIZE_GAP_FOR_SPACES.grid(row=7, column=3, sticky=W)

sFrame = Frame(master, bd=2, relief=GROOVE)

LABEL_WINDOW_SETTINGS = Label(sFrame, text="Window Settings")
LABEL_WINDOW_SETTINGS.grid(row=0, column=1, sticky=W)
SCALE_WINDOW_WIDTH = Scale(sFrame, variable=fields.VAR_ENTRY_WINDOW_WIDTH, from_=400, to=1920, tickinterval=1520, orient=HORIZONTAL, resolution=4, length=500, command=lambda x: updateXScales(), label="Window Width in Pixels:")
SCALE_WINDOW_WIDTH.grid(row=1, column=1, sticky=W)

SCALE_IMAGE_X_POS = Scale(sFrame, variable=fields.VAR_ENTRY_IMAGE_X_POS, from_=0, to=400, tickinterval=400, orient=HORIZONTAL, resolution=1, length=500, label="Image X Coordinate (location of image center)")
SCALE_IMAGE_X_POS.grid(row=1, column=3, sticky=W)

SCALE_MESSAGE_X_POS = Scale(sFrame, variable=fields.VAR_ENTRY_MESSAGE_X_POS, from_=0, to=400, tickinterval=40, orient=HORIZONTAL, resolution=1, length=500, label="Message X Coordinate (location of message start)")
SCALE_MESSAGE_X_POS.grid(row=2, column=1, sticky=W)

SCALE_BG_X_POS = Scale(sFrame, variable=fields.VAR_ENTRY_BACKGROUND_X_POS, from_=0, to=400, tickinterval=400, orient=HORIZONTAL, resolution=1, length=500, label="Background X Coordinate (location of BG center)")
SCALE_BG_X_POS.grid(row=2, column=3, sticky=W)

SCALE_WINDOW_HEIGHT = Scale(sFrame, variable=fields.VAR_ENTRY_WINDOW_HEIGHT, from_=40, to=1080, tickinterval=1040, orient=HORIZONTAL, resolution=4, length=500, command=lambda x: updateYScales(), label="Window Height in Pixels:")
SCALE_WINDOW_HEIGHT.grid(row=3, column=1, sticky=W)

SCALE_BG_Y_POS = Scale(sFrame, variable=fields.VAR_ENTRY_BACKGROUND_Y_POS, from_=0, to=40, tickinterval=40, orient=HORIZONTAL, resolution=1, length=500, label="Background Y Coordinate (location of BG center)")
SCALE_BG_Y_POS.grid(row=3, column=3, sticky=W)

dFrame.grid(row=0, column=0, sticky=NSEW, padx=4, pady=4)
wFrame.grid(row=0, column=1, sticky=NSEW, padx=4, pady=4)
mFrame.grid(row=0, column=2, sticky=NSEW, padx=4, pady=4)
sFrame.grid(row=1, column=0, columnspan=3, sticky=NSEW, padx=4, pady=4)
master.mainloop()
mainloop()
